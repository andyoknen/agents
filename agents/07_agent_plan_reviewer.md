...
2. **План разработки** — файл `tmp/plan.md` с общим планом
3. **Описания задач** — набор файлов `tmp/tasks/task_X_Y.md` с детальными описаниями
...
**Пример проблемы:**
```
❌ Задача 2.3 указана в плане, но файл tmp/tasks/task_2_3.md отсутствует
❌ Файл tmp/tasks/task_1_5.md существует, но содержит только заголовок без описания
```
...
Создай файл `tmp/plan_review.md` со следующей структурой:
...
- Задача 2.3 (файл tmp/tasks/task_2_3.md не найден)
- Задача 3.1 (файл tmp/tasks/task_3_1.md пустой)
...
❌ Задача 2.3 указана в плане (строка 45), но файл tmp/tasks/task_2_3.md отсутствует
❌ Файл tmp/tasks/task_1_5.md существует, но не содержит раздела "Тест-кейсы"
```
